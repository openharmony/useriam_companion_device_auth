...
pub const TOKEN_VALID_PERIOD: u64 = 4 * 60 * 60 * 1000; // 4 hours in ms
pub const TOKEN_REFRESH_THRESHOLD: u64 = 60 * 60 * 1000; // 1 hour in ms
...
pub const SUPPORT_CAPABILITIES: &[u16] =
