...
public:
    ...
    enum AttributeKey : uint32_t {
        ...
        ATTR_CDA_SA_REMOTE_TOKEN_ID = 200025,
        ATTR_CDA_SA_BUSINESS_ID_LIST = 200026,
        ATTR_CDA_SA_AUTH_TYPE = 200027,
        ATTR_CDA_SA_NAVIGATION_BUTTON_TEXT = 200028,
        ATTR_CDA_SA_HOST_SUB_PROFILE_ID = 200029,
        ATTR_CDA_SA_COMPANION_SUB_PROFILE_ID = 200030,
        ATTR_CDA_SA_DEVICE_SUB_PROFILE_NAME = 200031,
        ATTR_CDA_SA_ATL = 200032,
