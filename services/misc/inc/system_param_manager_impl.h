...
#ifndef COMPANION_DEVICE_AUTH_SYSTEM_PARAM_MANAGER_IMPL_H
#define COMPANION_DEVICE_AUTH_SYSTEM_PARAM_MANAGER_IMPL_H
...
public:
    ...
    ~SystemParamManagerImpl() override = default;
...
#endif // COMPANION_DEVICE_AUTH_SYSTEM_PARAM_MANAGER_IMPL_H
