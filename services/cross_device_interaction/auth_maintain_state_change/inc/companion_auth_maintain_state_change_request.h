...
#ifndef COMPANION_DEVICE_AUTH_COMPANION_AUTH_MAINTAIN_STATE_CHANGE_REQUEST_H
#define COMPANION_DEVICE_AUTH_COMPANION_AUTH_MAINTAIN_STATE_CHANGE_REQUEST_H
...
class CompanionAuthMaintainStateChangeRequest
    : public OutboundRequest,
      public std::enable_shared_from_this<CompanionAuthMaintainStateChangeRequest> {
public:
...
#endif // COMPANION_DEVICE_AUTH_COMPANION_AUTH_MAINTAIN_STATE_CHANGE_REQUEST_H
