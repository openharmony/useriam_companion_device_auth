...
static const ContinuousAuthSubscriptionFuzzFunction g_fuzzFuncs[] = {
    FuzzGetUserId,
    FuzzGetTemplateId,
    FuzzGetWeakPtr,
    FuzzOnCallbackAdded,
...
constexpr uint8_t NUM_FUZZ_OPERATIONS = sizeof(g_fuzzFuncs) / sizeof(ContinuousAuthSubscriptionFuzzFunction);
