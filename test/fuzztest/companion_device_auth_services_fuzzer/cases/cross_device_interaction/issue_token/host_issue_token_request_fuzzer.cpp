...
using FuzzFunction = void (*)(std::shared_ptr<HostIssueTokenRequest> &request, FuzzedDataProvider &fuzzData);
...
{
    RequestType newRequestType = static_cast<RequestType>(fuzzData.ConsumeIntegralInRange<uint32_t>(0, 100));
