...
static void FuzzHandleRequestWithEmptyAttrs(std::shared_ptr<CompanionTokenAuthHandler> &handler,
    FuzzedDataProvider &fuzzData)
{
    (void)fuzzData;
...
static void FuzzHandleRequestWithLargeAttrs(std::shared_ptr<CompanionTokenAuthHandler> &handler,
    FuzzedDataProvider &fuzzData)
{
...
static void FuzzGetMessageType(std::shared_ptr<CompanionTokenAuthHandler> &handler, FuzzedDataProvider &fuzzData)
{
    (void)fuzzData;
    (void)handler->GetMessageType();
}

static void FuzzHandleIncomingMessage(std::shared_ptr<CompanionTokenAuthHandler> &handler, FuzzedDataProvider &fuzzData)
{
    Attributes request = GenerateFuzzAttributes(fuzzData);
...
static void FuzzHandleIncomingMessageWithEmptyAttrs(std::shared_ptr<CompanionTokenAuthHandler> &handler,
    FuzzedDataProvider &fuzzData)
{
    (void)fuzzData;
    Attributes emptyRequest;
...
static void FuzzRegister(std::shared_ptr<CompanionTokenAuthHandler> &handler, FuzzedDataProvider &fuzzData)
{
    (void)fuzzData;
    handler->Register();
}
...
{
    auto handler = std::make_shared<CompanionTokenAuthHandler>();
    if (!handler) {
        return;
    }
