...
const FILE_ID: u16 = TestFileId::CompanionDeviceDbManagerTest as u16;
/*
...
#[test]
fn dummy_companion_device_db_manager_test() {
    ...
    assert!(dummy_companion_device_db_manager.get_device(0).is_err());
    assert!(dummy_companion_device_db_manager.get_device_list(Box::new(|_| true)).is_empty());
    assert!(dummy_companion_device_db_manager.remove_device(0).is_err());
    assert!(dummy_companion_device_db_manager.update_device(&device_info).is_err());
    assert!(dummy_companion_device_db_manager.generate_unique_template_id().is_err());
    assert!(dummy_companion_device_db_manager.add_token(&token).is_err());
    assert!(dummy_companion_device_db_manager.get_token(0, ProcessorType::Default).is_err());
    ...
    assert!(dummy_companion_device_db_manager
        ...
        .is_err());
    assert!(dummy_companion_device_db_manager.delete_device_capability_info(0).is_err());
    assert!(dummy_companion_device_db_manager.read_device_sk(0).is_err());
    assert!(dummy_companion_device_db_manager.write_device_sk(0, &Vec::<CompanionDeviceSk>::new()).is_err());
    assert!(dummy_companion_device_db_manager.delete_device_sk(0).is_err());
}
