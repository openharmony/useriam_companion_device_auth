...
protected:
    ...
    DeviceKey hostDeviceKey_ = { .idType = DeviceIdType::UNIFIED_DEVICE_ID,
        ...
        .deviceUserId = 100 };
    LocalDeviceStatus localDeviceStatus_ = { .protocols = { ProtocolId::VERSION_1 },
...
HWTEST_F(CompanionSyncDeviceStatusHandlerTest, HandleRequest_001, TestSize.Level0)
{
    ...
    EXPECT_CALL(mockCrossDeviceCommManager_, GetLocalDeviceStatus())
        .WillOnce(Return(localDeviceStatus_))
        .WillOnce(Return(localDeviceStatus_));
