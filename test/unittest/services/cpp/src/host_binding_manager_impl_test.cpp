...
public:
    void SetUp() override
    {
        ...
        ON_CALL(mockCrossDeviceCommManager_, SubscribeLocalDeviceStatus(_))
            .WillByDefault(Invoke([](OnLocalDeviceStatusChange &&) { return MakeSubscription(); }));
        ON_CALL(mockCrossDeviceCommManager_, GetLocalDeviceStatus()).WillByDefault(Return(LocalDeviceStatus {}));
