...
constexpr int32_t COMPANION_SUB_PROFILE_ID = INVALID_SUB_PROFILE_ID;
...
HWTEST_F(CompanionRevokeTokenRequestTest, OnConnected_001, TestSize.Level0)
{
    ...
    auto request = std::make_shared<CompanionRevokeTokenRequest>(UserKey{COMPANION_USER_ID, COMPANION_SUB_PROFILE_ID},
        HOST_DEVICE_KEY, REASON);
