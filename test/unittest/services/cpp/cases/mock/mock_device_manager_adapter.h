...
#ifndef MOCK_DEVICE_MANAGER_ADAPTER_H
#define MOCK_DEVICE_MANAGER_ADAPTER_H
...
public:
    MOCK_METHOD(bool, InitDeviceManager, (), (override));
...
#endif // MOCK_DEVICE_MANAGER_ADAPTER_H
