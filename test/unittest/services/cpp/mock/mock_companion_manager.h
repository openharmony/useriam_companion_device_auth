...
public:
    ...
    MOCK_METHOD(ResultCode, EndAddCompanion,
        (RequestId requestId, const PersistedCompanionStatus &companionStatus, SecureProtocolId secureProtocolId,
            const std::vector<uint8_t> &addHostBindingReply, std::vector<uint8_t> &outFwkMsg),
        (override));
