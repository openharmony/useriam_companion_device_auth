...
public:
    ...
    MOCK_METHOD(LocalDeviceStatus, GetLocalDeviceStatus, (), (override));
    MOCK_METHOD(std::unique_ptr<Subscription>, SubscribeLocalDeviceStatus, (OnLocalDeviceStatusChange && callback),
        (override));
